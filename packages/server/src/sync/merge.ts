 ...
 * - Очистка категории: patch различает "поле отсутствует" (undefined, нет
 *   изменений) и "поле явно очищено" (null, categoryId сбрасывается) — только
 *   для существующих item; при вставке нового item null трактуется как
 *   "категория не указана явно" (см. carry-over по имени ниже).
 */
